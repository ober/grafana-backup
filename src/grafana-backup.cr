...
module GrafanaBackup
  ...
  def self.run
    ...
    begin
      ...
      puts "\nAWS Authentication (one of the following):"
      puts "  1. Environment variables:"
      puts "     AWS_ACCESS_KEY_ID - AWS access key"
      puts "     AWS_SECRET_ACCESS_KEY - AWS secret key"
      puts "  2. AWS credentials file (~/.aws/credentials)"
      puts "     AWS_PROFILE - Profile name (default: default)"
      puts "  3. IAM instance role (automatic on EC2)"
